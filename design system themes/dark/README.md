...
The 12-column grid, 1440px maximum width, 60ch reading measure and 24px gutters are mandatory. Use the page margins, vertical section rhythm and 16 / 10 hero ratio from colors_and_type.css. Layout belongs to this system alongside palette and typography.

## Composition

Reserve two columns for navigation and ten for the workspace. Keep summary metrics above the primary work area, contextual controls next to their content and a compact activity region below.
