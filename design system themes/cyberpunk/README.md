...
The 12-column grid, 1440px maximum width, 52ch reading measure and 16px gutters are mandatory. Use the page margins, vertical section rhythm and 16 / 9 hero ratio from colors_and_type.css. Layout belongs to this system alongside palette and typography.

## Composition

Use a compact two-column navigation rail and a ten-column instrument field. Align status strips, the main visual and supporting telemetry to hard grid edges. Keep scan order clear despite dense detail.
