...
The 12-column grid, 1120px maximum width, 64ch reading measure and 32px gutters are mandatory. Use the page margins, vertical section rhythm and 4 / 3 hero ratio from colors_and_type.css. Layout belongs to this system alongside palette and typography.

## Composition

Use a quiet masthead, a broad lead image and a narrow continuous reading column. Align small figures to the same grid and separate chapters with generous whitespace, not dense card surfaces.
