...
The 12-column grid, 1200px maximum width, 60ch reading measure and 24px gutters are mandatory. Use the page margins, vertical section rhythm and 16 / 10 hero ratio from colors_and_type.css. Layout belongs to this system alongside palette and typography.

## Composition

Use a five-column message beside a seven-column product image. Continue with aligned feature rows, evidence and a final action; preserve a clear header and shared outer grid.
