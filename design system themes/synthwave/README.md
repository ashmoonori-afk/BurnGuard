...
The 12-column grid, 1280px maximum width, 52ch reading measure and 28px gutters are mandatory. Use the page margins, vertical section rhythm and 16 / 9 hero ratio from colors_and_type.css. Layout belongs to this system alongside palette and typography.

## Composition

Place a panoramic visual stage beneath a centered headline and above the main action. Continue in wide horizontal chapters with compact captions and generous gaps; do not introduce a permanent side rail.
