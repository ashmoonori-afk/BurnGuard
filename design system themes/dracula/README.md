...
The 12-column grid, 1320px maximum width, 64ch reading measure and 24px gutters are mandatory. Use the page margins, vertical section rhythm and 16 / 10 hero ratio from colors_and_type.css. Layout belongs to this system alongside palette and typography.

## Composition

Keep a two-column contents rail and a ten-column reading workspace. Place the page title above continuous documentation, inset code examples and a small related-links footer; do not box every paragraph.
