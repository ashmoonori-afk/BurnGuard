...
export function isRuntimeSource(relativePath: string): boolean {
  ...
  return normalized === "LICENSE" || normalized === "NOTICE" || normalized.startsWith("assets/fonts/") || normalized.startsWith("assets/liquid-glass/") || (normalized.startsWith("design system themes/") && !normalized.startsWith("design system themes/previews/")) || normalized.startsWith("samples/original/") ||
