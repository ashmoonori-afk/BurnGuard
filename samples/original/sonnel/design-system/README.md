...
## Purpose / copy voice
정밀한 계기판의 규칙성과 손에 닿는 따뜻함. 짧은 기술 주석과 구체적인 한국어 설명.
가상 브랜드임을 명시합니다. 성능 주장, 고객 후기, 수상, 판매 가능성을 만들지 않습니다.

## Palette / typography
Background #e7e4dc; ink #242624; accent #ef5b24. Orange is a control highlight; small text stays ink.
Display: Arial,sans-serif. Body: Arial, sans-serif. Caption: Consolas,monospace. No external fonts. Body 16–20px with 1.7 line height. Fluid display type with clamp.
